...
export function listVisibleStories(context: StoriesContext, query: StoriesQuery) {
  return callEdgeFunction(context, { functionName: "stories", method: "GET", query });
}

export function listArchivedStories(context: StoriesContext) {
  return callEdgeFunction(context, { functionName: "stories", method: "GET", query: { archive: true } });
}

export function createStory(context: StoriesContext, input: CreateStoryInput) {
  return callEdgeFunction(context, { functionName: "stories", method: "POST", body: input });
}
